# Welcome!
Thank you for your interest in contributing to the CDC's Cloud Enablement initiative. There are many ways to contribute, including writing tutorials or blog posts, improving the documentation, submitting bug reports and feature requests, and writing code for PRIME itself.
...
If you think you found a bug in our code, search our [issues list](https://github.com/cdcgov/dibbs-cloud/issues) in case someone has opened a similar issue. We'll close duplicate issues to help keep our backlog neat and tidy.
...
As you code, please make sure you add proper comments, documentation, and unit tests. This project adheres to strict quality guidelines, regardless of whether a contributing engineer is on the team or external. Please also ensure that you thoroughly test your changes on your local machine before submitting.
...
## Credit
This document is a mashup of contributor documents from the CDC, ElasticSearch, and SimpleReport. 
